...
public class VodUtil {
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tMbFd3ufi46dTasc8Uh";
        //您的AccessKeySecret
        String accessKeySecret = "RZTG55zdOrqkWQankjjDRcgxdwrlhv";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "D:\\project\\courseFile\\course\\GBK6ZQfAmOkwymAuiEC8G.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
            ...
            JSONObject uploadAuth = JSONObject.parseObject(
                    org.apache.tomcat.util.codec.binary.Base64.decodeBase64(createUploadVideoResponse.getUploadAuth()), JSONObject.class);
