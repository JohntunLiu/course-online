  ...
  <main role="main">
    ...
    <div class="album py-5 bg-light eye-protector-processed" style="transition: background-color 0.3s ease 0s; background-color: rgb(248, 249, 250);">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm eye-protector-processed" style="transition: background-color 0.3s ease 0s; background-color: rgb(255, 255, 255);">
          ...
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm eye-protector-processed" style="transition: all 0s ease 0s; background-color: rgb(255, 255, 255);">
              <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
